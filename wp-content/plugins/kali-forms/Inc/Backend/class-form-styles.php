...
class Form_Styles
{
    ...
    public function set_styles()
    {
        $this->styles = [
            ...
            [
                'id' => 'roundedBordersBg',
                'label' => esc_html__('Rounded borders with background on input', 'kaliforms'),
            ...
            [
                ...
                'label' => esc_html__('Straight borders with background on input', 'kaliforms'),
                'thumb' => KALIFORMS_URL . '/assets/img/styles/straight-borders-bg.png',
            ],
            [
                'id' => 'inputBg',
                'label' => esc_html__('Input with background', 'kaliforms'),
                'thumb' => KALIFORMS_URL . '/assets/img/styles/input-with-bg.png',
            ],
            [
                'id' => 'inputBgRounded',
                'label' => esc_html__('Rounded input with background', 'kaliforms'),
            ...
            [
                ...
                'label' => esc_html__('Compact with label overlap', 'kaliforms'),
